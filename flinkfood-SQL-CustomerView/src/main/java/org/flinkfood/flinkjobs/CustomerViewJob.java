...
public class CustomerViewJob {
        ...
        public static void main(String[] args) throws Exception {
                ...
                DataStream<Customer> streamCustomer = env
                                .fromSource(sourceCustomer, WatermarkStrategy.forMonotonousTimestamps(), "Kafka Source")
                                .keyBy(Customer::getId);

                DataStream<Address> streamAddress = env
                                .fromSource(sourceAddress, WatermarkStrategy.forMonotonousTimestamps(), "Kafka Source")
                ...
                DataStream<String> resultStream = streamCustomer
                                ...
                                .between(Time.days(-30), Time.days(30)) // Example: 5-second window
                                .lowerBoundExclusive()
                                .upperBoundExclusive()
